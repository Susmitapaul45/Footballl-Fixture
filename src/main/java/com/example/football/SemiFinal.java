...
public class SemiFinal implements Initializable {
    private String current = "SemiFinal.fxml";
    @FXML
    ...
    ObservableList<GroupSTG> list = FXCollections.observableArrayList(
            new GroupSTG("TBD", "TBD", "14 December,2022","1:00 AM"),
            new GroupSTG("TBD", "TBD", "15 December,2022","1:00 AM")
    );
