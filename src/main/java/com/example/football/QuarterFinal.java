...
public class QuarterFinal implements Initializable {

    private String current = "QuarterFinal.fxml";
    @FXML
    ...
    ObservableList<GroupSTG> list = FXCollections.observableArrayList(
            ...
            new GroupSTG("TBD", "TBD", "9 December,2022","9:00 PM"),
            new GroupSTG("TBD", "TBD", "10 December,2022","1:00 AM"),
            new GroupSTG("TBD", "TBD", "10 December,2022","9:00 PM"),
            new GroupSTG("TBD", "TBD", "11 December,2022","1:00 AM")
